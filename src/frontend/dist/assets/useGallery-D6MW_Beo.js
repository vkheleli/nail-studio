import { x as o, r as reactExports, y as vt, z as useActor, A as useQuery, D as useQueryClient, F as useMutation, G as createActor } from "./index-C_6JvaI4.js";
var jt = (n) => {
  switch (n) {
    case "success":
      return ee;
...
function useGalleryByService(serviceTypeId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
export {
  ue as a,
  useGallery as b,
  useGalleryByService as c,
  useAddImage as d,
  useDeleteImage as e,
  useAddServiceType as f,
  useUpdateServiceType as g,
  useDeleteServiceType as h,
  useServiceTypes as u
};
